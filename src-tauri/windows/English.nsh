...
LangString appRunning ${LANG_ENGLISH} "${PRODUCTNAME} is running. Close it, then try again."
...
LangString dontUninstallDowngrade ${LANG_ENGLISH} "Do not uninstall (downgrading without uninstall is disabled)"
LangString failedToKillApp ${LANG_ENGLISH} "Failed to close ${PRODUCTNAME}. Close it, then try again."
LangString installingWebview2 ${LANG_ENGLISH} "Installing WebView2..."
LangString newerVersionInstalled ${LANG_ENGLISH} "A newer version of ${PRODUCTNAME} is installed. This installer cannot downgrade it."
LangString older ${LANG_ENGLISH} "older"
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed. Select how to continue."
LangString silentDowngrades ${LANG_ENGLISH} "Downgrades are disabled for this installer.$\n"
LangString unableToUninstall ${LANG_ENGLISH} "Unable to uninstall ${PRODUCTNAME}."
...
LangString webview2AbortError ${LANG_ENGLISH} "WebView2 could not be installed. LSDJ cannot run without it. Check the network connection, or install the Microsoft WebView2 Evergreen Runtime and retry."
...
LangString webview2Downloading ${LANG_ENGLISH} "Downloading the Microsoft WebView2 bootstrapper..."
...
LangString deleteAppData ${LANG_ENGLISH} "Also remove downloaded models, runtimes, settings, and user data (the path and size will be confirmed)"
